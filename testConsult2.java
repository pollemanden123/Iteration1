...
public class testConsult2 implements ActionListener {
        ...
        testConsult2(){
            ...
            newerGUI.add(tf1);newerGUI.add(tf3);newerGUI.add(b1);newerGUI.add(b2);
            newerGUI.setSize(300,200);
            newerGUI.setLayout(null);
            newerGUI.setVisible(true);
        }
